...
class Form extends Component {
    state = {
        // Inicializa el estado con un objeto vacío para almacenar los datos del formulario
        data: {}
    };
    ...
    render() {
        ...
        return (
            <form className='block p-6 rounded-lg shadow-lg bg-white max-w-sm' onSubmit={this.handleSubmit}>
                {schema.map((field, i) => {
                    switch (field.type) {
                        case 'text':
                            return (
